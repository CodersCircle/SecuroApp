        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => AddPasswordScreen(editItem: widget.item),
              ),
            ),
          ),
          IconButton(
          ...
          child: ListView(
            ...
            children: [
              ...
              _DetailTile(
                ...
                onCopy: () =>
                    ClipboardUtil.copyAndAutoClear(widget.item.username),
              ),
              ...
              if (widget.item.websiteUrl.isNotEmpty) ...[
                ...
                _DetailTile(
                  ...
                  onCopy: () =>
                      ClipboardUtil.copyAndAutoClear(widget.item.websiteUrl),
                ),
              ],
  ...
  Future<void> _confirmDelete(BuildContext context) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (dialogCtx) => AlertDialog(
        ...
        content:
            Text('Delete ${widget.item.platformName}? This cannot be undone.'),
        actions: [
          TextButton(
