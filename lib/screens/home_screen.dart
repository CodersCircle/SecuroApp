    ...
    if (isWide) {
      return Scaffold(
        body: Row(
          children: [
            NavigationRail(
              extended: isUltraWide,
              selectedIndex: _index,
              onDestinationSelected: (i) => setState(() => _index = i),
              labelType: isUltraWide
      ...
      child: ClipRRect(
        ...
        child: NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(
              icon: Icon(Icons.qr_code_2_outlined),
              selectedIcon: Icon(Icons.qr_code_2_rounded, color: AppTheme.primary),
              label: 'Auth',
            ),
            NavigationDestination(
              icon: Icon(Icons.password_outlined),
              selectedIcon: Icon(Icons.password_rounded, color: AppTheme.primary),
              label: 'Generator',
            ),
            NavigationDestination(
              icon: Icon(Icons.settings_outlined),
